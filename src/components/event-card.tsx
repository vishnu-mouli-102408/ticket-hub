      ...
      return (
        <div className="mt-4">
          <button
            ...
            className="w-full bg-gray-100 cursor-pointer text-gray-700 px-6 py-3 rounded-lg font-medium hover:bg-gray-200 transition-colors duration-200 shadow-sm flex items-center justify-center gap-2"
          >
