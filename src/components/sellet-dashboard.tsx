...
export default function SellerDashboard() {
  ...
  }, [fetchAccountStatus, stripeConnectId]);
  ...
  console.log("IS READY TO ACCEPT PAYMENTS", isReadyToAcceptPayments);
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  ...
                  {!accountLinkCreatePending && (
                    <button
                      ...
                      className="mt-4 bg-yellow-600 cursor-pointer text-white px-4 py-2 rounded-lg hover:bg-yellow-700 transition-colors"
                    >
              ...
              <div className="flex flex-wrap gap-3 mt-6">
                {accountStatus.isActive && (
                  <button
                    ...
                    className="bg-blue-600 cursor-pointer text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors flex items-center"
                  >
                ...
                <button
                  ...
                  className="bg-gray-100 cursor-pointer text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 transition-colors"
                >
                  Refresh Status
                </button>
              </div>
